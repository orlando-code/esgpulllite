...
from esgpulllite import __file__
from esgpulllite.config import Config
from esgpulllite.models import File, Query, Table, sql
from esgpulllite.version import __version__

# from esgpulllite.exceptions import NoClauseError
...
class Database:
    ...
    def get_files_by_query(self, query, status=None):
        ...
        from esgpulllite.models.query import query_file_proxy
        import sqlalchemy as sa
